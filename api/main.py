...
def get_video_details(video_id):
    ...
    if 'items' in data and data['items']:
        ...
        try:
            transcript = youtube_transcript_api.YouTubeTranscriptApi.get_transcript(video_id, proxies={"https": "http://mitko105@gmail.com:P@rafl0w0806@amsterdam.nl.socks.nordhold.net:1080"}, languages=['en', 'de', 'jp', 'fr', 'pt', 'es', 'ru','it','ko','nl'])
